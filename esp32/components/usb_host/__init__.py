# Override of the built-in usb_host component.
# Only change: usb_host_component.cpp adds USB PHY init for OTG Host mode.
# All Python config/codegen is inherited from the built-in component.
...
CODEOWNERS = ["@clydebarrow", "@rhooper"]
DEPENDENCIES = ["esp32"]
...
def usb_device_schema(cls=USBClient, vid: int = None, pid: list = None) -> cv.Schema:
